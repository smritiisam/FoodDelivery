...
// signup
// Invoke-RestMethod -Uri "http://localhost:5000/api/auth/login" -Method POST -Headers @{ "Content-Type" = "application/json" } -Body '{"email":"smriti@example.com","password":"mysecurepassword"}'
